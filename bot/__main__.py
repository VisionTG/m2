...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("BY", "https://t.me/TGFilmZone")
    buttons.buildbutton("Owner", "https://t.me/Telegram")
    reply_markup = buttons.build_menu(2)
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''

★ This bot can mirror/leech all your links to Google Drive or to telegram!
'''
        sendMarkup(start_string, context.bot, update.message, reply_markup)
    else:
        sendMarkup('Access Denied, deploy your own mirror-leech bot', context.bot, update.message, reply_markup)
