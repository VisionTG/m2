...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://www.github.com/RangoTG/RangoTG "><i class="fab fa-github"></i></a>
        <a href="https://t.me/TGFilmZone"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
<body>
   <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://www.github.com/RangoTG/m2"><i class="fab fa-github"></i></a>
        <a href="https://t.me/TGFilmZone"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
@app.route('/')
def homepage():
    return "<h1>See Cloudx Bot 2 Running Successfully</h1>"
